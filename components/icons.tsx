...
export const FolderUploadIcon = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path d="M20.9 10.3A2 2 0 0 0 19 9h-1.1a2 2 0 0 1-1.79-1.11L15 6H9L7.89 7.89A2 2 0 0 1 6.1 9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-4.3" />
    </svg>
);
...
export const MagicWandIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="m15 22 2-2-2-2-2 2 2 2Z" />
    <path d="m11 7 2.5 2.5-8.5 8.5-2.5-2.5L11 7Z" />
  </svg>
);
